...
The `pyproject.toml` next to this file pins `pyright` to the fork's version and
mirrors its `[tool.pyright]` (default "standard" mode, `pythonVersion = "3.12"`),
so this reproduces what the fork's CI reports. Each block names the rule pyright
applies and the shape of the message.
"""
